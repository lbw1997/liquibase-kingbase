            ...
            return getResultSetCache("getTables").get(new ResultSetCache.SingleResultSetExtractor(database) {
                ...
                public List<CachedRow> fastFetchQuery() throws SQLException, DatabaseException {
                    ...
                    if (database instanceof OracleDatabase) {
                        ...
                        return queryKingbase(catalogAndSchema, table);
                    }
                ...
                private List<CachedRow> queryKingbase(CatalogAndSchema catalogAndSchema, String tableName) throws DatabaseException, SQLException {
